...
module.exports = function(app) {
  ...
  app.get('/', function(req, res) {
    ...
    Project.get(currentUser.name, function(err, projects) {
      if (!projects) {
        projects = [];
      }
  ...
  app.get('/creatProject', function(req, res) {
    res.render('creatProject', {
      title: '注册'
    });
  });
  //创建项目
  app.post('/creatProject', function(req, res) {
    var projectUser = req.session.user,
        project = {
          name: req.body.name
        },
        newProject = new Project(projectUser.name, project);
  ...
  app.get('/remove/:id', function(req, res) {
    ...
    Project.remove(req.params.id, function(err) {
      if (err) {
        req.flash('error', err);
  ...
  //跳转到项目页面
  app.get('/project/:id', checkLogin);
  app.get('/project/:id', function(req, res) {
    Project.getOne(req.params.id, function (err,oneProject) {
  ...
  app.post('/login', function(req, res) {
    ...
    User.get(req.body.name, function(err, user) {
      ...
      req.flash('success', '登陆成功1!');
      req.flash('userName', 'afdsfa登陆成功1!');
